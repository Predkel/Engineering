...
<script src="${pageContext.request.contextPath}/asserts/js/validate.js"></script>
...
<div class="container">
    ...
    <form class="center-block" action="substances" method="POST">
    ...
    <div class="row">
        <div class="center-block">
            ...
            <c:if test="${previousPage!=0}">
                <a href="${pageContext.request.contextPath}/tosubstances?page=${previousPage}">
                    <img src="${pageContext.request.contextPath}/asserts/images/leftArrow.png" WIDTH="20" HEIGHT="20"
                         BORDER="0"></a>
            </c:if>

            <c:if test="${showFirstPage==true}">
                <a href="${pageContext.request.contextPath}/tosubstances?page=1">
            ...
            <c:forEach items="${beforeThisPage}" var="number">
                <a href="${pageContext.request.contextPath}/tosubstances?page=${number}">
            ...
            <c:if test="${showLastPage==true}">
                <a href="${pageContext.request.contextPath}/tosubstances?page=${countOfPages}">
                    <button class="btn btn-default">${countOfPages}</button>
                </a>
            </c:if>

            <c:if test="${nextPage!=0}">
                <a href="${pageContext.request.contextPath}/tosubstances?page=${nextPage}">
